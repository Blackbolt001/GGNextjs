...
export default function Layout({children}) {
 ...
 if (!session) {
  return (
    <div className=" relative mx-auto bg-[url('https://img1.wallspic.com/previews/0/3/5/8/3/138530/138530-urbanarea-water-light-city-blue-x350.jpg')] z-1 justify-center  bg-no-repeat top center bg-center min-h-screen flex flex-wrap">
      ...
      <div className="   p- flex flex-auto">
        ...
        <span className="text-black-400 hover:text-neon-yellow hover:blur-none blur-sm duration-700 z-3"> Designs </span> 
        </h1>
        <div>
        <h2 className="text-silver-600 mx-4 text-center font-bold text-3x1 blur-sm hover:text-candlelight-200 hover:blur-none duration-1000 z-2"> <ul>Backend Dashboard platforms</ul>
        <ul>
  ...
  return (
    ...
    <div className="  mx-auto bg-[url('https://img1.wallspic.com/previews/0/3/5/8/3/138530/138530-urbanarea-water-light-city-blue-x350.jpg')] z-1 justify-center  bg-no-repeat top center bg-center min-h-screen flex flex-wrap">
    <h1></h1>
    <div className="   p- flex flex-auto">
      <h1 className="text-neon-blue font-bold text-6xl hover:text-neon-blue  hover:blur-none duration-1000 z-5">Georgia Goose
      <span className="text-black-400 hover:text-neon-yellow hover:blur-none blur-sm duration-700 z-3"> Designs </span> 
